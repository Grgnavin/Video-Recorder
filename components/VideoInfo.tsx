...
const VideoInfo = ({
  ...
  return (
    <section className="video-info">
      ...
      <button className="bg-pink-100 text-white px-4 py-3 rounded-4xl cursor-pointer text-base font-semibold hover:bg-pink-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
        Delete Video
      </button>
    </section>
  );
